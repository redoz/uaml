...
// Shown when starting a new model from the rail while the canvas already has
// content. Unlike Clear canvas, this is a calm, intentional "start fresh" — not a
// red destructive warning. We still offer an OKF export so nothing is lost by
// accident, and call out when the current model has never been saved.
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/30" onClick={onClose}>
      <div className="w-[460px] rounded-2xl bg-white p-7 shadow-xl" onClick={e => e.stopPropagation()}>
        ...
        <p className="mt-3 text-[13.5px] leading-relaxed text-slate-600">
          ...
          {savedModel
            ? "Your current model stays saved; you can reopen it from Models anytime."
